    ...
    <PublicLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-display font-extrabold text-gray-900 mb-3">Privacy Policy</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 mb-3">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 mb-3">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 mb-3">7. Contact</h2>
