    ...
    <PublicLayout>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">2. Eligibility</h2>
            <p>You must be at least 13 years of age to use ReClaim. By using the service, you confirm you meet this requirement.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">3. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">4. Content Ownership</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">5. Prohibited Activities</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">6. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-display font-bold text-gray-900 dark:text-white mb-3">9. Changes to Terms</h2>
